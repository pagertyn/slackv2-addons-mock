    ...
    <nav className="nav nav-global nav-global-hover navbar-dark flex-column nav-pills mr-auto">
      ...
      <div className="dropdown">
        ...
        <div className="dropdown-menu">
          ...
          <a className="dropdown-item" href="/rules">Event Rules <span className="badge badge-primary">NEW</span></a>
          ...
          <a className="dropdown-item" href="/incident_priorities">Incident Priorities <span className="badge badge-primary">NEW</span></a>
        ...
        <div className="nav-global-footer-user">
          ...
          <div className="user__details">
            ...
            <div className="user__on-call-status">
              <div className="on-call-status__indicator"></div>
