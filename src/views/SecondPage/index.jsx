          ...
          {this.state.loaded && (
            ...
            <div>
              ...
              <Row>
                ...
                <div className="alert alert-info" role="alert">
                  <span className="sr-only">modal asking to filter </span>
                  <h4 className="alert-heading">Choose how to migrate your existing service channels</h4>
                  <hr/>
                  <p className="fs-sm">
                    We have 
                  </p>
                  <Button className="btn  btn-secondary mr-1">Migrate for my Team</Button><Button className="btn  btn-secondary">Migrate for a Service</Button>
                  <a  className="alert-link float-right">Another time, thanks.</a>
                </div>
              <Row>
              ...
              <Row className="d-flex flex-wrap">
                <Col className="col-lg-9 col-12 flex-grow-1">
                  ...
                  <CardTitle tag="h2">Migrate V1 to V2</CardTitle>
                  <p>Great! Now that your workspace is successfully linked, the next step is to migrate your channels.  </p>
                    <div className="dropdown">
                        <button className="btn btn-secondary dropdown-toggle mr-1" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                          Select PagerDuty Team
                        </button>
                        <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                          <a className="dropdown-item" href="#">Retail Operations</a>
                          <a className="dropdown-item" href="#">Database Reliability</a>
                          <a className="dropdown-item" href="#">Web & eCommerce</a>
                          <a className="dropdown-item" href="#">Security</a>
                        </div>
                      <Button className="btn  btn-primary">Migrate Channels</Button>
                    </div>
                    <hr></hr>
                    <div className="dropdown">
                        <button className="btn btn-secondary dropdown-toggle mr-1" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                          <a className="dropdown-item" href="#">Checkout Systems</a>
                          <a className="dropdown-item" href="#">DB01</a>
                          <a className="dropdown-item" href="#">DB02</a>
                          <a className="dropdown-item" href="#">DB03</a>
                          <a className="dropdown-item" href="#">Web-UI</a>
                          <a className="dropdown-item" href="#">Webhoook Transformers</a>
                          <a className="dropdown-item" href="#">Search API</a>
                          <a className="dropdown-item" href="#">Volume Monitoring</a>
                        </div>
                      <Button className="btn  btn-primary">Migrate Channels</Button>
                    </div>
                  </Card>
                ...
                <Col className="col-lg-3 col-12 mb-2 flex-grow-1 mb-1">
                  <p className="ml-1">Why do I need to migrate my old channels?</p>
                  <p className="ml-1 fs-sm">Migrating channels to V2 will enable you to execute slash commands and do a lot more with your workspace.</p>
                </Col>
              </Row>
              <Row>
                <Col>
